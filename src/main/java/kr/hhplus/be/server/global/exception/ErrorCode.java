...
public enum ErrorCode {
    ...
    LOCK_ACQUIRED_FAILED(HttpStatus.INTERNAL_SERVER_ERROR.value(), HttpStatus.INTERNAL_SERVER_ERROR.name()),
    INTERNAL_LOCK_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), HttpStatus.INTERNAL_SERVER_ERROR.name()),
